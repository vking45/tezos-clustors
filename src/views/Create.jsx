const Create = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p className="leading-relaxed text-lg">We are currently allowing the creation of clustors through better-call.dev only as there are chances of people making errors in the token addresses 
      ...
      <div className="p-2 w-full">
          ...
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-6 h-6 mt-1 ml-1" viewBox="0 0 24 24">
